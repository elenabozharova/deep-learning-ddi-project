"""
Milestone 9e — ChemBERTa MLP "faithful-training" ablation: test-set evaluator.

Must be run AFTER train_chemberta_mlp_faithful.py has produced:
    outputs/polyllm/chemberta_faithful_training/checkpoints/best_model.pt
    outputs/polyllm/chemberta_faithful_training/validation_threshold.json

Usage:
    .venv-polyllm/Scripts/python.exe src/polyllm/evaluate_chemberta_mlp_faithful.py
    .venv-polyllm/Scripts/python.exe src/polyllm/evaluate_chemberta_mlp_faithful.py --overwrite
